...
<br />
<div align="center">
  <a href="https://github.com/KaraboMolemane/git-user-details-api">
    <img src="images/logo.png" alt="Logo" width="80" height="80">
  </a>

<h3 align="center">Git User Details API</h3>
  <p align="center">
    A bootcamp capstone task that uses React & Express to get a Git user details using the <a href="https://docs.github.com/en/rest/quickstart?apiVersion=2022-11-28">GitHub API</a> and display it accordingly.
    <br />
    <a href="https://github.com/KaraboMolemane/git-user-details-api"><strong>Explore the docs »</strong></a>
    <br />
    <br />
    <a href="https://github.com/KaraboMolemane/git-user-details-api">View Demo</a>
    ·
    <a href="https://github.com/KaraboMolemane/git-user-details-api/issues">Report Bug</a>
    ·
    <a href="https://github.com/KaraboMolemane/git-user-details-api/issues">Request Feature</a>
  </p>
</div>
...
<div align="center">
    <img src="images/search.png" alt="Logo" width="650" height="450" >
</div>

Enter the phrase and hit 'Search'. The search result from the [Git API](https://docs.github.com/en/rest/quickstart?apiVersion=2022-11-28) will be shown.

<div align="center">
    <img src="images/search-results.png" alt="Logo" width="650" height="450" >
</div>

Select a user from the serach results to see the user details.

<div align="center">
    <img src="images/user-details.png" alt="Logo" width="650" height="450" >
</div>

You can click on one of the user's repo to see the repo details. 

<div align="center">
    <img src="images/repo-details.png" alt="Logo" width="650" height="450" >
</div>
...
See the [open issues](https://github.com/KaraboMolemane/git-user-details-api/issues) for a full list of proposed features (and known issues).
...
Project Link: [https://github.com/KaraboMolemane/git-user-details-api](https://github.com/KaraboMolemane/git-user-details-api)
